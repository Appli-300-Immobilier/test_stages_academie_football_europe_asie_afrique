...
<li>- 0703313371</li>
            <li>Email: contact@teststagesacademiefootballeuropeasieafrique.cm</li>
            ...
            <li className="flex items-center gap-4 pt-2">
              ...
              <a href="https://wa.me/2250707170971" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
