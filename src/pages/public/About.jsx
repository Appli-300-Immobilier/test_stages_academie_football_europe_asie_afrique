    ...
    <div className="flex flex-col gap-20 pb-20">
      ...
      <section className="bg-slate-50 py-20 border-b">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-secondary-dark mb-6">À À Propos de Test, Stages,academie football Europe-Asie-Afrique</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-secondary leading-relaxed">
              ...
              Test, Stages,academie football Europe-Asie-Afrique s'est donné pour mission de fournir des éééquipements de haute qualité, modernes et fiables. 
